    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos PC Non MDA Growth (Total) as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos PC Non MDA Growth (Total) delivered -0.6% for the month, and 2.3% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos PC Non MDA Growth (Total) delivered 12.6%, significantly beating Inflation by 9.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos PC Non MDA Growth (Total) has  outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos PC Non MDA Growth (Total) has delivered 7.2%, significantly beating Inflation by 3.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos PC Non MDA Growth (Total) has  underperformed since inception of the strategy. </p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos PC Non MDA Growth (Total)</h1>
