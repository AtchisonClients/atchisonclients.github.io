    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos BT Non MDA Balanced (Total) as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos BT Non MDA Balanced (Total) delivered -0.3% for the month, and 1.8% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos BT Non MDA Balanced (Total) delivered 10.8%, significantly beating Inflation by 7.9%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos BT Non MDA Balanced (Total) has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos BT Non MDA Balanced (Total) has delivered 5.9%, significantly beating Inflation by 2.4%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos BT Non MDA Balanced (Total) has marginally underperformed since inception of the strategy. </p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos BT Non MDA Balanced (Total)</h1>
