    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Edwards Marshall - Dynamic 60 with Direct AusEq as at 30 September 2025</h2>
                    ...
                    <p>The Edwards Marshall - Dynamic 60 with Direct AusEq delivered 0.5% for the month, and 3.7% over the quarter. </p>
                    <p>Over the last 12 months, the Edwards Marshall - Dynamic 60 with Direct AusEq delivered 11.3%, significantly beating Inflation by 9.3%. 
                    Relative to the Peer Group (FE AMI Peer Average), Edwards Marshall - Dynamic 60 with Direct AusEq has materially outperformed over the last 12 months. </p>
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+15.17%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.41%)</li><li>The asset class with the highest absolute return was International Shares (+65.49%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+10.66%)</li><li>Attribution analysis relative to SAA shows nan having the highest impact on value add at (+nan%).</li><li>Whereas, nan was found to have a (+nan%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
        ...
        <br>
            ...
            case '1-performance':
                content = `
                    <h1>Edwards Marshall - Dynamic 60 with Direct AusEq</h1>
