    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth Real Assets Model as at 31 March 2025</h2>
                    ...
                    <p>The PMP Wealth Real Assets Model delivered -3.1% for the month, and -2.0% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth Real Assets Model delivered 3.0%,  beating Inflation by 0.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth Real Assets Model has  outperformed over the last 12 months. </p>
