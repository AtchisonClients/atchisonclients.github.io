    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth Real Assets Model as at 31 December 2024</h2>
                    ...
                    <p>The PMP Wealth Real Assets Model delivered -4.3% for the month, and -2.9% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth Real Assets Model delivered 13.8%, significantly beating Inflation by 11.0%. 
                    ...
                    <p>Since inception of the strategy, the PMP Wealth Real Assets Model has delivered 6.9%, significantly beating Inflation by 3.4%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth Real Assets Model has  outperformed since inception of the strategy. </p>
        ...
        <br>
            ...
            case '4-attribution':
                content = `
                    ...
                    <iframe src="./Charts/6_Real_Sleeve_Components.html" height="380px" width="950px"></iframe>
