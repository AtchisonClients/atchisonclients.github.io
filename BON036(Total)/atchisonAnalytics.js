    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total Direct Moderate Portfolio as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos Total Direct Moderate Portfolio delivered -0.2% for the month, and 0.8% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total Direct Moderate Portfolio delivered 7.6%, materially beating Inflation by 4.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Direct Moderate Portfolio has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total Direct Moderate Portfolio has delivered 4.0%,  beating Inflation by 0.5%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Direct Moderate Portfolio has marginally outperformed since inception of the strategy. </p>
                    <h4>Key Contributors, Detractors & Attribution</h4>
                    <ul><li>On a weighted basis, the asset class that contributed to the most to the portfolio return was International Shares at (+10.00%)</li><li>The asset class that contributed the least to portfolio return was Alternatives at (+0.49%)</li><li>The asset class with the highest absolute return was International Shares (+58.61%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+7.35%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+4.19%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-7.58%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos Total Direct Moderate Portfolio</h1>
