    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Wattle Client #5 - Full Portfolio as at 31 January 2025</h2>
                    ...
                    <h4>Sensitivity Analysis - Portfolio vs ASX 200</h4>
                    <iframe src="./Charts/2_AusEqSensitivity.html" height="500px" width="950px"></iframe>

                    <h4>Sensitivity Analysis - Portfolio vs S&P 500</h4>
                    <iframe src="./Charts/2_USEqSensitivity.html" height="500px" width="950px"></iframe>
                    
                    <h4>Correlation Analysis - Aus Eq Holdings</h4>
                    <iframe src="./Charts/6_AusEq_MthCorrel.html" height="820px" width="950px"></iframe>

                    <h4>Correlation Analysis - Int Eq Holdings</h4>
                    <iframe src="./Charts/6_IntEq_MthCorrel.html" height="820px" width="950px"></iframe>

                
                    <br>    
                    <h4>Performance Comments</h4>                
                    <p>The Wattle Client #5 - Full Portfolio delivered 2.6% for the month, and 7.5% over the quarter. </p>
                    <p>Over the last 12 months, the Wattle Client #5 - Full Portfolio delivered 20.1%, significantly beating Inflation by 17.4%. 
                    Relative to the Peer Group (FE AMI Peer Average), Wattle Client #5 - Full Portfolio has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Wattle Client #5 - Full Portfolio has delivered 9.1%, significantly beating Inflation by 5.2%. 
                    Relative to the Peer Group (FE AMI Peer Average), Wattle Client #5 - Full Portfolio has significantly outperformed since inception of the strategy. </p>
        ...
        <br>
            ...
            case '1-performance':
                content = `
                    <h1>Wattle Client #5 - Full Portfolio</h1>
                    <h4>Updated to: 31 January 2025</h2>
                    <h4>Inception:  31 December 2021</h2>
                    <br>
                    ...
                    <p>All performance metrics listed above are net of appointed investment management fees but before tax. Where noted, the Since Inception date of this analysis is: 31 December 2021. All performance is based on daily asset returns using portfolio target weights. Where a portfolio target weight change has been input into the dataset, it is assumed to have been applied as at the end of day asset valuations. </p>          
