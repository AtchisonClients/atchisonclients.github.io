    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total Diversified Moderate Portfolio as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos Total Diversified Moderate Portfolio delivered -0.2% for the month, and 0.8% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total Diversified Moderate Portfolio delivered 7.5%, materially beating Inflation by 4.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Diversified Moderate Portfolio has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total Diversified Moderate Portfolio has delivered 4.1%,  beating Inflation by 0.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Diversified Moderate Portfolio has marginally outperformed since inception of the strategy. </p>
                    <h4>Key Contributors, Detractors & Attribution</h4>
                    <ul><li>On a weighted basis, the asset class that contributed to the most to the portfolio return was International Shares at (+10.02%)</li><li>The asset class that contributed the least to portfolio return was Alternatives at (+0.49%)</li><li>The asset class with the highest absolute return was International Shares (+58.76%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+7.37%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+4.15%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-6.91%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos Total Diversified Moderate Portfolio</h1>
