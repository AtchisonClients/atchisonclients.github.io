    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total Diversified Moderate Portfolio as at 30 November 2024</h2>
                    ...
                    <p>The Bongiornos Total Diversified Moderate Portfolio delivered 1.7% for the month, and 1.8% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total Diversified Moderate Portfolio delivered 10.4%, significantly beating Inflation by 7.5%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Diversified Moderate Portfolio has  outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total Diversified Moderate Portfolio has delivered 4.2%,  beating Inflation by 0.7%. 
