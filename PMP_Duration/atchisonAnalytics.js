    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth Long Duration Model as at 30 June 2025</h2>
                    ...
                    <p>The PMP Wealth Long Duration Model delivered 1.0% for the month, and 1.7% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth Long Duration Model delivered 6.0%, materially beating Inflation by 3.9%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth Long Duration Model has marginally outperformed over the last 12 months. </p>
