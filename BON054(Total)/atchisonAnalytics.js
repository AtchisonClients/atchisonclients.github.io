    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos PC Non MDA Aggressive (Total) as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos PC Non MDA Aggressive (Total) delivered -0.7% for the month, and 2.9% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos PC Non MDA Aggressive (Total) delivered 14.6%, significantly beating Inflation by 11.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos PC Non MDA Aggressive (Total) has marginally underperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos PC Non MDA Aggressive (Total) has delivered 8.4%, significantly beating Inflation by 4.9%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos PC Non MDA Aggressive (Total) has  underperformed since inception of the strategy. </p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos PC Non MDA Aggressive (Total)</h1>
