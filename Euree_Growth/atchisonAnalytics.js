    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Euree Growth Portfolio as at 30 April 2025</h2>
                    ...
                    <p>The Euree Growth Portfolio delivered 1.0% for the month, and -2.1% over the quarter. </p>
                    <p>Over the last 12 months, the Euree Growth Portfolio delivered 10.3%, significantly beating Inflation by 8.5%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+7.97%)</li><li>The asset class that contributed the least to portfolio return was Floating Rate at (+0.47%)</li><li>The asset class with the highest absolute return was Alternatives (+42.35%)</li><li>Whilst the asset class with the lowest absolute return was Cash (+7.84%)</li><li>Attribution analysis relative to SAA shows Manager Effect (net fees) having the highest impact on value add at (+0.65%).</li><li>Whereas, Tactical Allocation Effect was found to have a (+0.22%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
