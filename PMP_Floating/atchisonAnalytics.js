    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth Floating Rate Model as at 31 December 2024</h2>
                    ...
                    <p>The PMP Wealth Floating Rate Model delivered 0.5% for the month, and 0.8% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth Floating Rate Model delivered 5.1%, materially beating Inflation by 2.3%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth Floating Rate Model has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the PMP Wealth Floating Rate Model has delivered 3.6%, marginally beating Inflation by 0.2%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth Floating Rate Model has  outperformed since inception of the strategy. </p>
        ...
        <br>
            ...
            case '4-attribution':
                content = `
                    ...
                    <iframe src="./Charts/6_Floating_Sleeve_Components.html" height="380px" width="950px"></iframe>
