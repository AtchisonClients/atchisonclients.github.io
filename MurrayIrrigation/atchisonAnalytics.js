    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Murray Irrigation Reserve as at 31 January 2025</h2>
                    ...
                    <p>The Murray Irrigation Reserve delivered 2.9% for the month, and 5.0% over the quarter. </p>
                    <p>Over the last 12 months, the Murray Irrigation Reserve delivered 16.8%, significantly beating Inflation by 14.0%. 
                    Relative to the Peer Group (FE AMI Peer Average), Murray Irrigation Reserve has significantly outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Murray Irrigation Reserve has delivered 13.8%, significantly beating Inflation by 9.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Murray Irrigation Reserve has significantly outperformed since inception of the strategy. </p>
        ...
        <br>
            ...
            case '1-performance':
                content = `
                    <h1>Murray Irrigation Reserve</h1>
                    <h4>Updated to: 31 January 2025</h2>
                    <h4>Inception:  30 June 2022</h2>
                    <br>
                    ...
                    <p>All performance metrics listed above are net of appointed investment management fees but before tax. Where noted, the Since Inception date of this analysis is: 30 June 2022. All performance is based on daily asset returns using portfolio target weights. Where a portfolio target weight change has been input into the dataset, it is assumed to have been applied as at the end of day asset valuations. </p>          
