    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Murray Irrigation Reserve as at 30 September 2025</h2>
                    ...
                    <p>The Murray Irrigation Reserve delivered 0.5% for the month, and 3.4% over the quarter. </p>
                    <p>Over the last 12 months, the Murray Irrigation Reserve delivered 9.7%, significantly beating Inflation by 7.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Murray Irrigation Reserve has  outperformed over the last 12 months. </p>
