    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos PC Non MDA Conservative (Total) as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos PC Non MDA Conservative (Total) delivered 0.2% for the month, and 0.7% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos PC Non MDA Conservative (Total) delivered 6.0%, materially beating Inflation by 3.1%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos PC Non MDA Conservative (Total) has  outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos PC Non MDA Conservative (Total) has delivered 2.8%,  returned below Inflation by 0.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos PC Non MDA Conservative (Total) has marginally underperformed since inception of the strategy. </p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos PC Non MDA Conservative (Total)</h1>
