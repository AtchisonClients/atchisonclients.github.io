    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Euree Balanced Portfolio as at 30 June 2025</h2>
                    ...
                    <p>The Euree Balanced Portfolio delivered 1.3% for the month, and 4.9% over the quarter. </p>
                    <p>Over the last 12 months, the Euree Balanced Portfolio delivered 11.2%, significantly beating Inflation by 9.1%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+7.46%)</li><li>The asset class that contributed the least to portfolio return was Floating Rate at (+0.96%)</li><li>The asset class with the highest absolute return was Alternatives (+45.76%)</li><li>Whilst the asset class with the lowest absolute return was Cash (+8.56%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (-0.31%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-0.66%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
