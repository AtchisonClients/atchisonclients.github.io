    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Euree Balanced Portfolio as at 20 February 2026</h2>
                    ...
                    <p>The Euree Balanced Portfolio delivered 0.7% for the month, and 0.6% over the quarter. </p>
                    <p>Over the last 12 months, the Euree Balanced Portfolio delivered 8.2%,  beating Inflation by 1.7%. 
        ...
        <h2>MARKET OVERVIEW - January 2026</h2>
        <ul>
            <li>Australian equities began the year on a strong footing, with the S&P/ASX 200 rising 2% in January. Sector returns were mixed, with Energy and Materials the standout performers, rising 11% and 9% respectively, supported by stronger oil and copper prices.</li>
            <li>In contrast, Information Technology extended its weakness into 2026, falling 9%.</li>
            <li>Most factor indices recorded gains, led by Momentum and Value, each up 3%, while Low Volatility edged down 1%.</li>
            <li>The CSI300 finished marginally in the red for the month down -0.2%, as strength in policy-supported technology and industrial names was offset by ongoing weakness in property-related sectors and subdued consumer sentiment.</li>
            <li>The S&P 500 recovered to reach record highs, ending January up 1%.</li>
            <li>Market gains broadened beyond mega-caps, with mid- and small-cap indices advancing 4% and 6%, signalling a wider participation in the rally.</li>
            <li>Sector leadership rotated toward cyclicals, with Energy and Materials rising 14% and 9%, while factor performance favoured dividend and value strategies over momentum.</li>
            <li>In Europe, Information Technology led gains in January, rising 11% driven by strong semiconductor stocks such as Besi and ASM International. Utilities climbed nearly 8%, while Consumer Discretionary lagged, falling 8%.</li>
            <li>In January 2026, the Reserve Bank of Australia lifted the official cash rate by 25 basis points to 3.85 per cent in response to persistent inflationary pressures, marking the first rate increase in over two years.</li>
            <li>US inflation remained elevated, leading markets to price a more hawkish Federal Reserve outlook, supporting the US dollar and weighing on rate-sensitive assets.</li>
            <li>Gold and silver continued their rally as investors sought exposure to hard assets. Silver performed strongly but saw a sharp one-day pullback late in the month (which has continued into February) as higher rate expectations weighed on precious metals.</li>
