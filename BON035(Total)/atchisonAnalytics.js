    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total Direct Conservative Portfolio as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos Total Direct Conservative Portfolio delivered -0.0% for the month, and 0.3% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total Direct Conservative Portfolio delivered 5.5%, materially beating Inflation by 2.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Direct Conservative Portfolio has marginally outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total Direct Conservative Portfolio has delivered 2.7%,  returned below Inflation by 0.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Direct Conservative Portfolio has marginally underperformed since inception of the strategy. </p>
                    <h4>Key Contributors, Detractors & Attribution</h4>
                    <ul><li>On a weighted basis, the asset class that contributed to the most to the portfolio return was International Shares at (+5.16%)</li><li>The asset class that contributed the least to portfolio return was Alternatives at (+0.44%)</li><li>The asset class with the highest absolute return was International Shares (+57.58%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+7.15%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+3.12%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-4.37%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos Total Direct Conservative Portfolio</h1>
