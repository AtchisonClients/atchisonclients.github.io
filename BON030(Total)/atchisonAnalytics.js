    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total Diversified Conservative Portfolio as at 30 November 2024</h2>
                    ...
                    <p>The Bongiornos Total Diversified Conservative Portfolio delivered 1.4% for the month, and 1.1% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total Diversified Conservative Portfolio delivered 8.0%, significantly beating Inflation by 5.1%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Diversified Conservative Portfolio has  outperformed over the last 12 months. </p>
