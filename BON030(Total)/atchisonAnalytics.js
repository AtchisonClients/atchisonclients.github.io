    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total Diversified Conservative Portfolio as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos Total Diversified Conservative Portfolio delivered -0.1% for the month, and 0.3% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total Diversified Conservative Portfolio delivered 5.4%, materially beating Inflation by 2.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Diversified Conservative Portfolio has marginally outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total Diversified Conservative Portfolio has delivered 2.7%,  returned below Inflation by 0.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Diversified Conservative Portfolio has marginally underperformed since inception of the strategy. </p>
                    <h4>Key Contributors, Detractors & Attribution</h4>
                    <ul><li>On a weighted basis, the asset class that contributed to the most to the portfolio return was International Shares at (+5.18%)</li><li>The asset class that contributed the least to portfolio return was Alternatives at (+0.44%)</li><li>The asset class with the highest absolute return was International Shares (+58.03%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+7.19%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+2.10%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-3.76%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos Total Diversified Conservative Portfolio</h1>
