    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total Diversified Aggressive Portfolio as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos Total Diversified Aggressive Portfolio delivered -0.8% for the month, and 2.5% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total Diversified Aggressive Portfolio delivered 14.7%, significantly beating Inflation by 11.9%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Diversified Aggressive Portfolio has marginally outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total Diversified Aggressive Portfolio has delivered 8.5%, significantly beating Inflation by 5.0%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Diversified Aggressive Portfolio has marginally underperformed since inception of the strategy. </p>
                    <h4>Key Contributors, Detractors & Attribution</h4>
                    <ul><li>On a weighted basis, the asset class that contributed to the most to the portfolio return was International Shares at (+28.53%)</li><li>The asset class that contributed the least to portfolio return was Floating Rate at (+0.15%)</li><li>The asset class with the highest absolute return was Floating Rate (+inf%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+8.42%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+2.19%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-13.74%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos Total Diversified Aggressive Portfolio</h1>
