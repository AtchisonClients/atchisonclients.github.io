    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total Direct Growth Portfolio as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos Total Direct Growth Portfolio delivered -0.6% for the month, and 2.0% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total Direct Growth Portfolio delivered 12.7%, significantly beating Inflation by 9.9%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Direct Growth Portfolio has  outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total Direct Growth Portfolio has delivered 7.1%, significantly beating Inflation by 3.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Direct Growth Portfolio has marginally underperformed since inception of the strategy. </p>
                    <h4>Key Contributors, Detractors & Attribution</h4>
                    <ul><li>On a weighted basis, the asset class that contributed to the most to the portfolio return was International Shares at (+23.33%)</li><li>The asset class that contributed the least to portfolio return was Floating Rate at (+0.26%)</li><li>The asset class with the highest absolute return was International Shares (+67.08%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+7.94%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+3.38%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-13.70%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos Total Direct Growth Portfolio</h1>
