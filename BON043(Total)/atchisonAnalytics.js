    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total ESG Growth Portfolio as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos Total ESG Growth Portfolio delivered -0.1% for the month, and 2.8% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total ESG Growth Portfolio delivered 15.3%, significantly beating Inflation by 12.5%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total ESG Growth Portfolio has significantly outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total ESG Growth Portfolio has delivered 8.8%, significantly beating Inflation by 3.9%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total ESG Growth Portfolio has significantly outperformed since inception of the strategy. </p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos Total ESG Growth Portfolio</h1>
