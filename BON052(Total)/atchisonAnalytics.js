    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos PC Non MDA Balanced (Total) as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos PC Non MDA Balanced (Total) delivered -0.3% for the month, and 1.8% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos PC Non MDA Balanced (Total) delivered 10.3%, significantly beating Inflation by 7.4%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos PC Non MDA Balanced (Total) has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos PC Non MDA Balanced (Total) has delivered 5.7%, significantly beating Inflation by 2.2%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos PC Non MDA Balanced (Total) has marginally underperformed since inception of the strategy. </p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos PC Non MDA Balanced (Total)</h1>
