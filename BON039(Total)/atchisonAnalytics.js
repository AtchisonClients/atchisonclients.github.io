    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total Direct Aggressive Portfolio as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos Total Direct Aggressive Portfolio delivered -0.7% for the month, and 2.6% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total Direct Aggressive Portfolio delivered 14.7%, significantly beating Inflation by 11.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Direct Aggressive Portfolio has marginally underperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total Direct Aggressive Portfolio has delivered 8.1%, significantly beating Inflation by 4.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Direct Aggressive Portfolio has  underperformed since inception of the strategy. </p>
                    <h4>Key Contributors, Detractors & Attribution</h4>
                    <ul><li>On a weighted basis, the asset class that contributed to the most to the portfolio return was International Shares at (+28.54%)</li><li>The asset class that contributed the least to portfolio return was Floating Rate at (+0.16%)</li><li>The asset class with the highest absolute return was Floating Rate (+inf%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+8.31%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+2.23%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-15.72%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos Total Direct Aggressive Portfolio</h1>
