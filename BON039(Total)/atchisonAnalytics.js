    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total Direct Aggressive Portfolio as at 30 November 2024</h2>
                    ...
                    <p>The Bongiornos Total Direct Aggressive Portfolio delivered 2.9% for the month, and 4.9% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total Direct Aggressive Portfolio delivered 18.8%, significantly beating Inflation by 15.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total Direct Aggressive Portfolio has materially underperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total Direct Aggressive Portfolio has delivered 8.4%, significantly beating Inflation by 4.8%. 
