    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos BT Non MDA Growth (Total) as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos BT Non MDA Growth (Total) delivered -0.6% for the month, and 2.3% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos BT Non MDA Growth (Total) delivered 13.2%, significantly beating Inflation by 10.3%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos BT Non MDA Growth (Total) has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos BT Non MDA Growth (Total) has delivered 7.4%, significantly beating Inflation by 4.0%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos BT Non MDA Growth (Total) has marginally underperformed since inception of the strategy. </p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos BT Non MDA Growth (Total)</h1>
