    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos PC Non MDA Moderate (Total) as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos PC Non MDA Moderate (Total) delivered -0.0% for the month, and 1.2% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos PC Non MDA Moderate (Total) delivered 7.8%, materially beating Inflation by 5.0%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos PC Non MDA Moderate (Total) has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos PC Non MDA Moderate (Total) has delivered 4.1%,  beating Inflation by 0.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos PC Non MDA Moderate (Total) has marginally outperformed since inception of the strategy. </p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos PC Non MDA Moderate (Total)</h1>
