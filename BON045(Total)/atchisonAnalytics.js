    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos BT Non MDA Conservative (Total) as at 31 December 2024</h2>
                    ...
                    <p>The Bongiornos BT Non MDA Conservative (Total) delivered 0.2% for the month, and 0.7% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos BT Non MDA Conservative (Total) delivered 6.3%, materially beating Inflation by 3.4%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos BT Non MDA Conservative (Total) has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos BT Non MDA Conservative (Total) has delivered 2.9%,  returned below Inflation by 0.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos BT Non MDA Conservative (Total) has marginally underperformed since inception of the strategy. </p>
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos BT Non MDA Conservative (Total)</h1>
                    <h4>Updated to: 31 December 2024</h2>
                    <h4>Inception:  01 January 2019</h2>
                    <br>
                    ...
                    <p>All performance metrics listed above are net of appointed investment management fees but before tax. Where noted, the Since Inception date of this analysis is: 01 January 2019. All performance is based on daily asset returns using portfolio target weights. Where a portfolio target weight change has been input into the dataset, it is assumed to have been applied as at the end of day asset valuations. </p>          
