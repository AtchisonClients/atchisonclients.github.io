    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Bongiornos Total ESG Conservative Portfolio as at 30 November 2024</h2>
                    ...
                    <p>The Bongiornos Total ESG Conservative Portfolio delivered 1.4% for the month, and 1.0% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Total ESG Conservative Portfolio delivered 8.8%, significantly beating Inflation by 5.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total ESG Conservative Portfolio has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Total ESG Conservative Portfolio has delivered 3.9%,  returned below Inflation by 1.2%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Total ESG Conservative Portfolio has  outperformed since inception of the strategy. </p>
                    
                `;
                break;
            case '1-performance':
                content = `
                    <h1>Bongiornos Total ESG Conservative Portfolio</h1>
