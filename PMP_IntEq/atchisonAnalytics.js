    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth International Equities Model as at 31 December 2024</h2>
                    ...
                    <p>The PMP Wealth International Equities Model delivered 0.6% for the month, and 5.8% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth International Equities Model delivered 23.9%, significantly beating Inflation by 21.1%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth International Equities Model has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the PMP Wealth International Equities Model has delivered 15.9%, significantly beating Inflation by 12.4%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth International Equities Model has significantly outperformed since inception of the strategy. </p>
                    <h4>Key Contributors, Detractors & Attribution</h4>
                    <ul><li>On a weighted basis, the largest holding contributor to the portfolio outcome has been Ironbark Royal London Concentrated Global Share Fund</li><li>The holding that contributed the least to portfolio return was Fairlight Global Mid-Small cap fund </li><li>The current holding with the highest absolute return has been Ironbark Royal London Concentrated Global Share Fund<li>Whilst the current holding with the lowest absolute return has been Fairlight Global Mid-Small cap fund </li></ul>
                    <p>Concentrated, low turnover (<10%) global portfolio that will hold 30-40 stocks. Will have a slight quality tilt due to the focus on ROIC in the fundamental bottom-up process. </p><p></p><p></p><p></p>
        ...
        <br>
            ...
            case '1-performance':
                content = `
                    <h1>PMP Wealth International Equities Model</h1>
