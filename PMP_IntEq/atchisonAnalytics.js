    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth International Equities Model as at 30 June 2025</h2>
                    ...
                    <p>The PMP Wealth International Equities Model delivered 1.6% for the month, and 6.3% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth International Equities Model delivered 11.4%, significantly beating Inflation by 9.3%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth International Equities Model has significantly underperformed over the last 12 months. </p>
