    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth International Equities Model as at 30 September 2025</h2>
                    ...
                    <p>The PMP Wealth International Equities Model delivered 1.0% for the month, and 2.0% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth International Equities Model delivered 12.7%, significantly beating Inflation by 10.6%. 
                    ...
                    <ul><li>On a weighted basis, the largest holding contributor to the portfolio outcome has been Ironbark Brown Advisory Global Share Fund</li><li>The holding that contributed the least to portfolio return was Fairlight Global Mid-Small cap fund </li><li>The current holding with the highest absolute return has been Ironbark Brown Advisory Global Share Fund<li>Whilst the current holding with the lowest absolute return has been Fairlight Global Mid-Small cap fund </li></ul>
