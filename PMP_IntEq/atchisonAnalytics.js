    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth International Equities Model as at 31 March 2025</h2>
                    ...
                    <p>The PMP Wealth International Equities Model delivered -3.2% for the month, and -1.8% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth International Equities Model delivered 6.0%, materially beating Inflation by 3.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth International Equities Model has materially underperformed over the last 12 months. </p>
