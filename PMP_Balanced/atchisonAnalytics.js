    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth Balanced Model as at 30 September 2025</h2>
                    ...
                    <p>The PMP Wealth Balanced Model delivered 0.3% for the month, and 3.1% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth Balanced Model delivered 8.1%, significantly beating Inflation by 6.0%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth Balanced Model has  underperformed over the last 12 months. </p>
