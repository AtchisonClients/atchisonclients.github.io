    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth Balanced Model as at 31 August 2025</h2>
                    ...
                    <p>The PMP Wealth Balanced Model delivered 1.6% for the month, and 3.8% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth Balanced Model delivered 9.1%, significantly beating Inflation by 7.2%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth Balanced Model has materially underperformed over the last 12 months. </p>
