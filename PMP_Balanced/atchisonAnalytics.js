    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for PMP Wealth Balanced Model as at 31 March 2025</h2>
                    ...
                    <p>The PMP Wealth Balanced Model delivered -2.0% for the month, and -0.4% over the quarter. </p>
                    <p>Over the last 12 months, the PMP Wealth Balanced Model delivered 4.7%, materially beating Inflation by 2.5%. 
                    Relative to the Peer Group (FE AMI Peer Average), PMP Wealth Balanced Model has marginally outperformed over the last 12 months. </p>
