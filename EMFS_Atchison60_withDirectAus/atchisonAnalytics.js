    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Edwards Marshall - Dynamic 60 with Direct AusEq as at 31 August 2025</h2>
                    ...
                    <p>The Edwards Marshall - Dynamic 60 with Direct AusEq delivered 0.6% for the month, and 3.7% over the quarter. </p>
                    <p>Over the last 12 months, the Edwards Marshall - Dynamic 60 with Direct AusEq delivered 11.8%, significantly beating Inflation by 9.9%. 
                    Relative to the Peer Group (FE AMI Peer Average), Edwards Marshall - Dynamic 60 with Direct AusEq has significantly outperformed over the last 12 months. </p>
